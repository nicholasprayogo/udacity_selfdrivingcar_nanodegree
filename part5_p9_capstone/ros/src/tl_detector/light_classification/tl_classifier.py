# source: https://github.com/justinlee007/CarND-Capstone/
# open-source model obtained from above repo 
...
class TLClassifier(object):
    def __init__(self,model_graph_file):
        #TODO load classifier
        cwd = os.path.dirname(os.path.realpath(__file__))

        model_path = os.path.join(cwd, "{}".format(model_graph_file))
